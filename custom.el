...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-window agent-recall agent-shell agent-shell-attention
                agent-shell-dashboard agent-shell-manager
                agent-shell-pet all-the-icons-completion
                all-the-icons-dired avy consult consult-dir
                ...
                git-timemachine google-c-style iedit kind-icon
                kotlin-mode lsp-java lsp-mode magit marginalia
                markdown-mode mermaid-mode multiple-cursors orderless
                popup rainbow-delimiters rainbow-identifiers
                scala-mode terraform-mode vertico ws-butler yaml-mode
                zerodark-theme))
